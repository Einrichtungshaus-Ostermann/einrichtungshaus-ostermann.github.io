...
class NAMESPACE_NAME extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('CONTAINER_NAME.plugin_dir', $this->getPath() . '/');
        $container->setParameter('CONTAINER_NAME.view_dir', $this->getPath() . '/Resources/views/');
